...
class DangKyScreen extends GetWidget<DangKyController> {
  @override
                                                                ...
                                                                child:
                                                                    Container(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              Padding(padding: getPadding(top: 6), child: Text("msg_nh_p_l_i_m_t_kh_u".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterRegular16))
                                                                            ]))),
                                                            Align(
                                                                alignment:
                                                                    Alignment
